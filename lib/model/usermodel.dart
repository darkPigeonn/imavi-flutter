...
List userModelFromJson(String str) => List.from(json.decode(str).map((x) => UserModel.fromJson(x)));

String userModelToJson(List data) => json.encode(List.from(data.map((x) => x.toJson())));
